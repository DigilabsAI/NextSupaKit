...
export const LogoIcon = (props: React.ComponentProps<"svg">) => (
    ...
    >
        ...
        <g clipPath="url(#canvas-clip)">
            <g transform="translate(28 36) scale(9.604)">
                <path
                    fill="none"
                    stroke="#111"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    d="M4.5 37.19a55 55 0 0 0 14.3 2.697a55 55 0 0 0 14.341-1.113m-.214-5.137l.214 5.138M8.653 15.014L4.5 37.191m30.474-15.494l7.931-.908m-2.128.244l.13 7.808"
                />
                <ellipse
                    cx="20.147"
                    cy="18.803"
